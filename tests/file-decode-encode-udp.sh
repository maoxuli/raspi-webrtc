...
# gst-launch-1.0 -v filesrc location="$HOME/Serenity-HD-DVD-Trailer.mp4" ! qtdemux ! h264parse config-interval=-1 ! omxh264dec ! x264enc ! rtph264pay ! udpsink port=5000 host=192.168.1.97
